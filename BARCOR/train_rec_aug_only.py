...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='redial_aug_only', help="Where to store the final model.")
    parser.add_argument("--log_dir", type=str, default='redial_aug_only', help="Where to store the final model.")
    parser.add_argument("--infer_dir", type=str, default='redial_aug_only', help="Where to store the final model.")
    parser.add_argument("--debug", action='store_true', help="Debug mode.")
    parser.add_argument("--dataset", type=str, default='./data/redial_rec', help="A file containing all data.")
    parser.add_argument("--aug_dataset", type=str, default='./data/redial_rec', help="A file containing all data.")
    ...
    # parser.add_argument('--repeated_item_removed', type=bool, default='true')
