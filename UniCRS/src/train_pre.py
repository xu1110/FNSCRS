...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='./redial_pre')
    parser.add_argument("--log_dir", type=str, default='redial_pre')
    parser.add_argument("--debug", action='store_true', help="Debug mode.")
    parser.add_argument("--language", type=str, default='english')
    # data
    parser.add_argument("--dataset", type=str, default='redial_pre')
    ...
    # model
    parser.add_argument("--model", type=str, default='microsoft/DialoGPT-small') # /data/wxh/model/GPT2_CN/data/wxh/model/dialogue_gpt
    parser.add_argument("--text_encoder", type=str, default='roberta-base') # /data/wxh/model/RoBERTa_cn/data/wxh/model/roberta-base
    ...
    parser.add_argument('--num_warmup_steps', type=int, default=801)# 1241
...
if __name__ == '__main__':
    ...
    train_dataset = CRSDataset(
        dataset=args.dataset, split='train',entity2id = kg['entity2id'], tokenizer=tokenizer, language=args.language, debug=args.debug, max_length=args.max_length,
        prompt_tokenizer=text_tokenizer, prompt_max_length=args.prompt_max_length,
        entity_max_length=args.entity_max_length
    )
    valid_dataset = CRSDataset(
        dataset=args.dataset, split='valid',entity2id = kg['entity2id'], tokenizer=tokenizer, language=args.language, debug=args.debug, max_length=args.max_length,
        prompt_tokenizer=text_tokenizer, prompt_max_length=args.prompt_max_length,
        entity_max_length=args.entity_max_length
    )
    test_dataset = CRSDataset(
        dataset=args.dataset, split='test',entity2id = kg['entity2id'], tokenizer=tokenizer, language=args.language, debug=args.debug, max_length=args.max_length,
        prompt_tokenizer=text_tokenizer, prompt_max_length=args.prompt_max_length,
        entity_max_length=args.entity_max_length
    )
